    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="javascript:void(0)" data-toggle="modal" data-target="#periodeModal" id="periode"
                class="nav-link"><b>Periode
                    {{session()->get('periode')['bulan']}}/{{session()->get('periode')['tahun']}}</b></a>
        </li>
...
<div class="modal fade" id="periodeModal" tabindex="-1" role="dialog" aria-labelledby="periodeLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 250px">
        <div class="modal-content">
          ...
          -->
                        <!-- <datalist id="month"> -->
                        <select class="form-control form-control-user" id="bulanPeriode" placeholder="Pilih Bulan..."
                            name="bulan">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{session('periode')['tahun']}}"
                            class="form-control form-control-user" id="tahunPeriode" placeholder="Tahun..."
                            name="tahun">
                    </div>

                    <button type="button" class="btn btn-primary btn-user btn-block" onclick="cekFormatPeriode()">Ubah
                        Periode</button>
            </div>
