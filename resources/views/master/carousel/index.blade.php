...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <b class="m-0" style="font-size: 14pt;">List Carousel</b>
                </div>
                <!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('.datatable').DataTable({
                    ...
                    serverSide: true,
                    autoWidth: true,
                    ajax: "{{ route('master.get-carousel') }}",
                ...
                $("div.test_btn").html(`
                    <a class="btn custom-btn btn-lg btn-md btn-success" href="{{ url('master/carousel/create') }}">
