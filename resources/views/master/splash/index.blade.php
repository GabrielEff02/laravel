...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <b class="m-0" style="font-size: 14pt;">List Splash Screen</b>
                </div>
                <!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    $(document).ready(function() {
        $.ajax({
            ...
            success: function(response) {
                ...
                $("div.test_btn").html(`
                    <a class="btn custom-btn btn-lg btn-md btn-success" href="{{ url('master/splash/create') }}">
