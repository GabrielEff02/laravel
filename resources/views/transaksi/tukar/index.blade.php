...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <b class="m-0" style="font-size: 14pt;">List Transaksi Penukaran Barang </b>
                </div>
                <!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card" style="padding-right:20px !important; padding-left:20px !important;">
                        ...
                        <div class="card-body"><br>
                            ...
                            <a class="btn btn-lg btn-md custom-btn  mt-1 mb-4 mr-4"
                                href="{{ url('transaksi/tukar/create') }}">
                                Tetapkan Driver
                            </a></a><a class="btn btn-lg btn-md custom-btn mt-1 mb-4"
                                href="{{ url('transaksi/tukar/edit') }}">
                                Ubah Status
                            </a>
                        </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('.datatable').DataTable({
                    ...
                    autoWidth: true,
                    ajax: "{{ route('transaksi.get-tukar') }}",
