            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('transaksi/tukar') }}">Transaksi</a></li>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control"
                                value="{{ number_format($header->total_amount, 0, ',', '.') }}" readonly>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" value="{{ $item->product_name }}"
                                        class="form-control form-control-sm" style="height: 60px; " readonly>
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="text" value="{{ number_format($item->price, 0, ',', '.') }}"
                                        class="form-control form-control-sm text-right" style="height: 60px; " readonly>
                                </td>
                                <td>
                                    <input type="text" value="{{ number_format($item->total_price, 0, ',', '.') }}"
                                        class="form-control form-control-sm text-right" style="height: 60px; " readonly>
                                </td>
                                <td class="text-center" style="vertical-align: middle;">
                                    <img src="{{ asset('img/gambar_produk_tukar_poin/' . $item->image_url) }}"
